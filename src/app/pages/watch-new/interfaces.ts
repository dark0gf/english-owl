...
export interface IVideoData {
   ...
   *
   **/
  textData: Array<{s: number, e: number, t: string, rt: string, englishTextBlocks: Array<IEnglishTextBlock>}>
}
...
export interface IEnglishTextBlocks {
  textBlocks: Array<IEnglishTextBlock>;
  translate: string;
}
...
export interface IPlayerFactoryResult {
  ...
  getCurrentText: () => Promise<IEnglishTextBlocks>;
  destroy: () => void;
};
